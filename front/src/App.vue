    ...
    <footer>
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <p>{{ settingsStore.settings.workingHours || 'Dush - Jum: 9:00 - 18:00' }}</p>
          <p>{{ settingsStore.settings.address || 'Toshkent sh., O\'zbekiston' }}</p>
          <p>{{ settingsStore.settings.phone || '+998 (90) 123-4567' }}</p>
        </div>
        <div class="footer-col">
          <h3>Ijtimoiy tarmoqlar</h3>
          <ul>
            <li><a :href="settingsStore.settings.telegramLink" target="_blank">Telegram Menejer</a></li>
            <li><a :href="settingsStore.settings.instagramLink" target="_blank">Instagram sahifa</a></li>
          </ul>
        </div>
      </div>
