      ...
      <section class="products-grid-section">
        ...
        <div class="grid-controls">
          ...
          <div class="control-actions">
            ...
            <button class="btn btn-secondary mobile-filter-toggle" @click="showFiltersMobile = !showFiltersMobile">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="margin-right: 6px; vertical-align: middle;">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
              </svg>
              {{ showFiltersMobile ? 'Yashirish' : 'Filtrlar' }}
            </button>
